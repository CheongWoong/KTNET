...
model_name=one_stage_ktnet_large
BERT_DIR=uncased_L-24_H-1024_A-16

log_dir=log_$model_name/synonym-replacement
output_dir=output_$model_name/synonym-replacement
...
nohup python3 src/run_squad.py \
  ...
  --predict_file $DATA/SQuAD/synonym-replacement/$model_name/dev-v2.0.json \
