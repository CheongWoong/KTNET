...
def main():
    ...
    parser.add_argument('--eval_token', type=str, default='../tokenization_squad/tokens_random-replacement/dev.tokenization.uncased.data', help='token file of dev set')
    parser.add_argument('--output_dir', type=str, default='output_squad_random-replacement/', help='output directory')
