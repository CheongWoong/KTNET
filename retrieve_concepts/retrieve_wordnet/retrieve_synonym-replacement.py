...
def main():
    ...
    parser.add_argument('--eval_token', type=str, default='sdfsdfaasdfasdf', help='token file of dev set')
    parser.add_argument('--output_dir', type=str, default='output_squad_synonym-replacement', help='output directory')
    parser.add_argument("--model_name", default='b', type=str, 
                        help="...")
    ...
    args.eval_token = '../tokenization_squad/tokens_synonym-replacement/'+args.model_name+'/dev.tokenization.uncased.data'
