...
def main():
    ...
    parser.add_argument("--output_dir", default='tokens_synonym-replacement', type=str, 
                        help="The output directory to dump tokenization results.")
    parser.add_argument("--model_name", default='b', type=str, 
                        help="...")
    parser.add_argument("--predict_file", default='asdasdasdasdasd', type=str,
    ...
    args.predict_file = '../ner_tagging_squad/output_synonym-replacement/'+args.model_name+'/dev-v2.0.tagged.json'
