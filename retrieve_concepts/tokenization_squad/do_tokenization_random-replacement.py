...
def main():
    ...
    parser.add_argument("--output_dir", default='tokens_random-replacement', type=str, 
                        help="The output directory to dump tokenization results.")
    parser.add_argument("--predict_file", default='../ner_tagging_squad/output_random-replacement/dev-v2.0.tagged.json', type=str,
