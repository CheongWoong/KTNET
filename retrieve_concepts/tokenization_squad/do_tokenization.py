...
def main():
    ...
    parser.add_argument("--train_file", default='../ner_tagging_squad/output/train-v2.0.tagged.json', type=str, help="SQuAD json for training. E.g., train-v1.1.json")
    parser.add_argument("--predict_file", default='../ner_tagging_squad/output/dev-v2.0.tagged.json', type=str,
