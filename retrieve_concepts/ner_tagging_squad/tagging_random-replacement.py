...
def parse_args():
    ...
    parser.add_argument("--output_dir", default='output_random-replacement', type=str, 
                        help="The output directory to store tagging results.")
    parser.add_argument("--predict_file", default='../../data/SQuAD/random-replacement/dev-v2.0.json', type=str,
