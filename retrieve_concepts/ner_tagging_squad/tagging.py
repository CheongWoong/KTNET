...
def parse_args():
    ...
    parser.add_argument("--train_file", default='../../data/SQuAD/train-v2.0.json', type=str, help="SQuAD json for training. E.g., train-v1.1.json")
    parser.add_argument("--predict_file", default='../../data/SQuAD/dev-v2.0.json', type=str,
