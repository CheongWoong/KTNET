...
def parse_args():
    ...
    parser.add_argument("--output_dir", default='output_synonym-replacement', type=str, 
                        help="The output directory to store tagging results.")
    parser.add_argument("--model_name", default='b', type=str, 
                        help="...")                        
    parser.add_argument("--predict_file", default='asdfasdfasdf', type=str,
...
if __name__ == '__main__':
    ...
    args.predict_file = '../../data/SQuAD/synonym-replacement/'+args.model_name+'/dev-v2.0.json'
    ...
    for dataset, path, name in zip((devset,), (args.predict_file,), ('dev',)):
        tagging(dataset, nlp)
